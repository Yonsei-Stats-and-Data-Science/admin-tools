c.JupyterHub.concurrent_spawn_limit = 6 # limits concurrent spawns
c.JupyterHub.active_user_window = 30 * 60 # user sessions are valid for 30 minutes
c.JupyterHub.data_files_path = '/usr/local/share/jupyterhub'
c.JupyterHub.active_server_limit = 10 # limits number of active servers(more than 10 people cannot access the server)
c.JupyterHub.admin_access = True
c.JupyterHub.admin_users = set(["dos"])
c.JupyterHub.spawner_class = "systemdspawner.SystemdSpawner"
c.JupyterHub.shutdown_on_logout = True

c.Application.log_level = 10

c.ServerApp.shutdown_no_activity_timeout = 60 * 60 # shutdown kernels after no activity for 60 minutes

c.MappingKernelManager.cull_idle_timeout = 20 * 60 # shutdown kernels after no activity for 20 minutes
c.MappingKernelManager.cull_interval = 2 * 60 # check for idle kernels every two minutes

c.LocalAuthenticator.create_system_users = False

c.Spawner.debug = False
c.Spawner.default_url = "/lab" # provide JupyterLab environment by default
c.Spawner.args = ["--KernelSpecManager.ensure_native_kernel=False"] # disable the default kernel
...
#  Default: '/home/dos/.local/share/jupyterhub'
# c.JupyterHub.data_files_path = '/home/dos/.local/share/jupyterhub'
